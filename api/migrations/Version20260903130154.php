 ...
 */
final class Version20260903130154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE card_listing (id BIGINT AUTO_INCREMENT NOT NULL, game VARCHAR(20) NOT NULL, card_id BINARY(16) NOT NULL, finish VARCHAR(20) NOT NULL, product_id VARCHAR(64) NOT NULL, stock INT NOT NULL, price DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX uniq_card_listing_game_card_finish (game, card_id, finish), UNIQUE INDEX uniq_card_listing_game_product (game, product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE image_job_queue (id BIGINT AUTO_INCREMENT NOT NULL, game VARCHAR(20) NOT NULL, card_id BINARY(16) NOT NULL, status VARCHAR(20) NOT NULL, attempts INT DEFAULT 0 NOT NULL, last_error LONGTEXT DEFAULT NULL, claimed_by VARCHAR(64) DEFAULT NULL, claimed_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX idx_image_job_queue_game_status_id (game, status, id), UNIQUE INDEX uniq_image_job_queue_game_card (game, card_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE mtg_set (id BINARY(16) NOT NULL, scryfall_id VARCHAR(36) NOT NULL, code VARCHAR(20) NOT NULL, mtgo_code VARCHAR(20) DEFAULT NULL, arena_code VARCHAR(20) DEFAULT NULL, tcgplayer_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, set_type VARCHAR(255) NOT NULL, released_at DATE DEFAULT NULL, card_count INT NOT NULL, printed_size INT DEFAULT NULL, digital TINYINT NOT NULL, foil_only TINYINT NOT NULL, nonfoil_only TINYINT NOT NULL, block_code VARCHAR(20) DEFAULT NULL, block VARCHAR(255) DEFAULT NULL, parent_set_code VARCHAR(20) DEFAULT NULL, icon_svg_uri VARCHAR(512) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX uniq_mtg_set_scryfall_id (scryfall_id), UNIQUE INDEX uniq_mtg_set_code (code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE unmatched_product (id BIGINT AUTO_INCREMENT NOT NULL, game VARCHAR(20) NOT NULL, product_id VARCHAR(64) NOT NULL, name VARCHAR(255) NOT NULL, payload JSON DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX uniq_unmatched_product_game_product (game, product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
